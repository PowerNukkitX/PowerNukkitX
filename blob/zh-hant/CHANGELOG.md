...
- [#726] 重做自定義功能（[點擊查看遷移文檔](https://github.com/PowerNukkitX/PowerNukkitX/pull/726#issuecomment-1281778804)）。
- [#730] 移動優化。
...
- [#718] 修復版本檢查。
- [#724] 修復潛聲傳感器在觀察者模式下依然會被觸發的漏洞（在[#728]中修復）。
...
<details>
  <summary>1.19.31-PNX</summary>

   1. [#1.19.31-r1] PNX-1.19.31-r1 (協議版本554)

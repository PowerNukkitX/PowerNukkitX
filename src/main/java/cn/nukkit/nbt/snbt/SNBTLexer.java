...
public class SNBTLexer implements SNBTConstants {
    private static final SNBTNfaData.NfaFunction[] nfaFunctions = SNBTNfaData.getFunctionTableMap(null);
    ...
    static final EnumSet<TokenType> regularTokens = EnumSet.of(
            EOF,
            COLON,
            COMMA,
            OPEN_BRACKET,
     ...
     */
    public SNBTLexer(
            String inputSource, CharSequence input, LexicalState lexState, int startingLine, int startingColumn) {
        this.inputSource = inputSource;
    ...
    private static String mungeContent(
        ...
        while (index < contentLength) {
            ...
            if (ch == '\n') {
                ...
                String fourHexDigits = content.subSequence(index + numConsecutiveUs, index + numConsecutiveUs + 4)
                        .toString();

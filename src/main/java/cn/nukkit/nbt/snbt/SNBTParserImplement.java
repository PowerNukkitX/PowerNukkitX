...
public class SNBTParserImplement implements SNBTConstants {
    ...
    private static final EnumSet<TokenType> first_set$SNBT_javacc$81$34 = first_set$SNBT_javacc$81$34_init();

    private static EnumSet<TokenType> first_set$SNBT_javacc$81$34_init() {
        return tokenTypeSet(OPEN_BRACKET, OPEN_BRACE, BOOLEAN, FLOAT, DOUBLE, INTEGER, LONG, BYTE, SHORT, STRING);
    }

    private static final EnumSet<TokenType> first_set$SNBT_javacc$84$35 = tokenTypeSet(BOOLEAN, BYTE);
    private static final EnumSet<TokenType> first_set$SNBT_javacc$84$65 = tokenTypeSet(BOOLEAN, BYTE);
    private static final EnumSet<TokenType> first_set$SNBT_javacc$90$21 = first_set$SNBT_javacc$90$21_init();

    private static EnumSet<TokenType> first_set$SNBT_javacc$90$21_init() {
        return tokenTypeSet(OPEN_BRACKET, OPEN_BRACE, BOOLEAN, FLOAT, DOUBLE, INTEGER, LONG, BYTE, SHORT, STRING);
    }
    ...
    private class ParseState {
        ...
        ParseState() {
            ...
            ArrayList<NonTerminalCall> parsingStack =
                    (ArrayList<NonTerminalCall>) SNBTParserImplement.this.parsingStack.clone();

...
public class FormWindowDialog implements Dialog {
    ...
    public FormWindowDialog(String title, String content, Entity bindEntity, List<ElementDialogButton> buttons) {
        ...
        if (this.bindEntity == null) throw new IllegalArgumentException("bindEntity cannot be null!");
    }
    ...
    public void setButtonJSONData(String json) {
        var buttons =
                GSON.<List<ElementDialogButton>>fromJson(json, new TypeToken<List<ElementDialogButton>>() {}.getType());
        // Cannot be null

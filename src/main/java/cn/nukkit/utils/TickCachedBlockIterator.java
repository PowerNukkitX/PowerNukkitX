...
public class TickCachedBlockIterator implements Iterator<Block> {
    ...
    public TickCachedBlockIterator(Dimension level, Vector3 start, Vector3 direction) {
        this(level, start, direction, 0);
    }

    public TickCachedBlockIterator(Dimension level, Vector3 start, Vector3 direction, double yOffset) {
        this(level, start, direction, yOffset, 0);
    }

    public TickCachedBlockIterator(Dimension level, Vector3 start, Vector3 direction, double yOffset, int maxDistance) {

...
public enum DyeColor {
    BLACK(
            ...
            new BlockColor(0x1D1D21),
            new BlockColor(0x00, 0x00, 0x00)),
    RED(
            1,
            14,
            1,
            ...
            new BlockColor(0xB02E26),
            new BlockColor(0xb0, 0x2e, 0x26)),
    GREEN(
            2,
            13,
            2,
            ...
            new BlockColor(0x5E7C16),
            new BlockColor(0x5e, 0x7c, 0x16)),
    BROWN(
            3,
            12,
            17,
            ...
            new BlockColor(0x835432),
            new BlockColor(0x83, 0x54, 0x32)),
    BLUE(
            4,
            11,
            18,
            ...
            new BlockColor(0x3C44AA),
            new BlockColor(0x3c, 0x44, 0xaa)),
    PURPLE(
            5,
            10,
            5,
            ...
            new BlockColor(0x8932B8),
            new BlockColor(0x89, 0x32, 0xb8)),
    ...
    LIGHT_GRAY(
            ...
            new BlockColor(0x9D9D97),
            new BlockColor(0x9d, 0x9d, 0x97)),
    ...
    YELLOW(
            ...
            new BlockColor(0xFED83D),
            new BlockColor(0xfe, 0xd8, 0x3d)),
    LIGHT_BLUE(
            12,
            3,
            12,
            ...
            new BlockColor(0x3AB3DA),
            new BlockColor(0x3a, 0xb3, 0xda)),
    MAGENTA(
            13,
            2,
            13,
            ...
            new BlockColor(0xC74EBD),
            new BlockColor(0xc7, 0x4e, 0xbd)),
    ORANGE(
            14,
            1,
            14,
            ...
            new BlockColor(0xFF9801),
            new BlockColor(0xf9, 0x80, 0x1d)),
    ...
    BONE_MEAL(
            ...
            new BlockColor(0xF0F0F0),
            new BlockColor(0xf0, 0xf0, 0xf0));
    ...
    private static final DyeColor[] BY_DYE_ITEM_DATA;
    ...
    DyeColor(
            ...
            BlockColor leatherColor,
            BlockColor signColor) {
        this(
                dyeColorMeta,
                woolColorMeta,
                itemDyeMeta,
    ...
    static {
        BY_WOOL_DATA = values();
        BY_DYE_ITEM_DATA = new DyeColor
                [Arrays.stream(BY_WOOL_DATA)
                                .mapToInt(DyeColor::getItemDyeMeta)
                                .max()
                                .orElse(0)
                        + 1];
    ...
    @PowerNukkitDifference(
            since = "1.4.0.0-PN",
            info = "When overflowed, instead of wrapping, the meta will be clamped, accepts the new dye metas")

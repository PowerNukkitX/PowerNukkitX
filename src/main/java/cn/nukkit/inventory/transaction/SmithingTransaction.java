...
public class SmithingTransaction extends InventoryTransaction {
    ...
    public void addAction(InventoryAction action) {
        ...
        if (action instanceof SmithingItemAction) {
            ...
            if (creativeAction.getActionType() == 0
                    ...
                    && !creativeAction.getTargetItem().isNull()
                    && creativeAction.getTargetItem().getId() == ItemID.NETHERITE_INGOT) {
                this.ingredientItem = action.getTargetItem();
            }
        }
    }
    ...
    public boolean canExecute() {
        ...
        if (outputItem == null
                || outputItem.isNull()
                || ((equipmentItem == null || equipmentItem.isNull())
                        && (ingredientItem == null || ingredientItem.isNull()))) {
            return false;
        }

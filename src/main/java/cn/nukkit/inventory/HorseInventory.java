    ...
    public void onSlotChange(int index, Item before, boolean send) {
        ...
        if (index == 0) {
            if (this.getSaddle().isNull()) {
                ...
                this.getHolder().getLevel().addLevelSoundEvent(this.getHolder(), SoundEvent.SADDLE, -1, this.getHolder().getIdentifier(), false, false);
            ...
            mobArmorEquipmentPacket.setRuntimeEntityId(this.getHolder().getId());
            mobArmorEquipmentPacket.setHelmet(toNetworkItem(Item.AIR));
            mobArmorEquipmentPacket.setChestplate(toNetworkItem(this.getHorseArmor()));
            mobArmorEquipmentPacket.setLeggings(toNetworkItem(Item.AIR));
            mobArmorEquipmentPacket.setBoots(toNetworkItem(Item.AIR));
            mobArmorEquipmentPacket.setBody(toNetworkItem(this.getHorseArmor()));

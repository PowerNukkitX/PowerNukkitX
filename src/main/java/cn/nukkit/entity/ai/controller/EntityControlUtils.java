...
public interface EntityControlUtils {
     ...
     * @deprecated 
     */
    void setLookTarget(Vector3 lookTarget) {
     ...
     * @deprecated 
     */
    void setMoveTarget(Vector3 moveTarget) {
     ...
     * @deprecated 
     */
    void setMoveDirectionStart(Vector3 moveDirectionStart) {
     ...
     * @deprecated 
     */
    void setMoveDirectionEnd(Vector3 moveDirectionEnd) {
     ...
     * @deprecated 
     */
    boolean isShouldUpdateMoveDirection() {
     ...
     * @deprecated 
     */
    void setShouldUpdateMoveDirection(boolean shouldUpdateMoveDirection) {
     ...
     * @deprecated 
     */
    void setEnablePitch(boolean enablePitch) {

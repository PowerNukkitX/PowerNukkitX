...
public class WalkToTargetExecutor implements IBehaviorExecutor {
    ...
    protected boolean needInitTarget(@NotNull EntityIntelligent entity) {
        return !entity.getMemoryStorage().contains(MoveTargetMemory.class);
    }

    protected void setTargetAndUpdateRoute(@NotNull EntityIntelligent entity, Vector3 vector3) {

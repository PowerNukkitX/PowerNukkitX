...
public class SpaceRandomRoamExecutor implements EntityControl, IBehaviorExecutor {
    ...
    public SpaceRandomRoamExecutor(float speed, int maxRoamRange, int frequency) {
        this(speed, maxRoamRange, frequency, false,
    ...
    public SpaceRandomRoamExecutor(float speed, int maxRoamRange, int frequency, boolean calNextTargetImmediately, int runningTime, boolean avoidWater, int maxRetryTime) {
        this.speed = speed;

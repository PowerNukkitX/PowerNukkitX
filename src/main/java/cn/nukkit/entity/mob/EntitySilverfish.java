...
public class EntitySilverfish extends EntityMob implements EntityWalkable, EntityArthropod {
    ...
    public IBehaviorGroup requireBehaviorGroup() {
        return new BehaviorGroup(
                ...
                Set.of(),
                Set.of(
                        new Behavior(new MeleeAttackExecutor(CoreMemoryTypes.ATTACK_TARGET, 0.4f, 40, true, 30), new AttackCheckEvaluator(), 3, 1),
                        new Behavior(new MeleeAttackExecutor(CoreMemoryTypes.NEAREST_PLAYER, 0.4f, 40, false, 30),
                                entity -> {

...
public class EntityHusk extends EntityZombie {
    ...
    public IBehaviorGroup requireBehaviorGroup() {
        return new BehaviorGroup(
                ...
                Set.of(),
                Set.of(
                        new Behavior(new HuskAttackExecutor(CoreMemoryTypes.ATTACK_TARGET, 0.3f, 40, true, 10, Effect.getEffect(Effect.HUNGER)), all(
                        ...
                        new Behavior(new HuskAttackExecutor(CoreMemoryTypes.NEAREST_PLAYER, 0.3f, 40, false, 10, Effect.getEffect(Effect.HUNGER)), all(

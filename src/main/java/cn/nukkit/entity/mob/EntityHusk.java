...
public class EntityHusk extends EntityZombie {
    ...
    public IBehaviorGroup requireBehaviorGroup() {
        return new BehaviorGroup(
                ...
                Set.of(),
                Set.of(
                        new Behavior(new PlaySoundExecutor(Sound.MOB_HUSK_AMBIENT, isBaby() ? 1.3f : 0.8f, isBaby() ? 1.7f : 1.2f, 1, 1), new RandomSoundEvaluator(), 4, 1),
                        new Behavior(new MeleeAttackExecutor(CoreMemoryTypes.ATTACK_TARGET, 0.3f, 40, true, 10, Effect.get(EffectType.HUNGER).setDuration(140)),new EntityCheckEvaluator(CoreMemoryTypes.ATTACK_TARGET), 3, 1),

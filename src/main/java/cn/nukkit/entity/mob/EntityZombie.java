...
public class EntityZombie extends EntityMob implements EntityWalkable, EntitySmite {
    ...
    public IBehaviorGroup requireBehaviorGroup() {
        return new BehaviorGroup(
                ...
                Set.of(),
                Set.of(
                        new Behavior(new MeleeAttackExecutor(CoreMemoryTypes.ATTACK_TARGET, 0.23f, 40, true, 20), all(
                        ...
                        new Behavior(new MeleeAttackExecutor(CoreMemoryTypes.NEAREST_PLAYER, 0.23f, 40, false, 20), all(
                        ...
                        new Behavior(new FlatRandomRoamExecutor(0.23f, 12, 100, false, -1, true, 10), (entity -> true), 1, 1)
                ),

...
public class EntityWolf extends EntityAnimal
                ...
                Set.of(
                        ...
                        new Behavior(
                                entity -> {
                                    ...
                                    boolean validAttacker = attackByEntityEvent != null
                                            && attackByEntityEvent.getDamager().isAlive()
                                            && (!(attackByEntityEvent.getDamager() instanceof Player player)
                                                    || player.isSurvival());
                                    if (hasOwner) {
                                        // 已驯服
                                        if (storage.notEmpty(CoreMemoryTypes.ENTITY_ATTACKING_OWNER)
                                                && storage.get(CoreMemoryTypes.ENTITY_ATTACKING_OWNER)
                                                        .isAlive()
                                                && !storage.get(CoreMemoryTypes.ENTITY_ATTACKING_OWNER)
                                                        .equals(this)) {
                                            // 攻击攻击主人的生物(排除自己)
                                        ...
                                        } else if (storage.notEmpty(CoreMemoryTypes.ENTITY_ATTACKED_BY_OWNER)
                                                && storage.get(CoreMemoryTypes.ENTITY_ATTACKED_BY_OWNER)
                                                        .isAlive()
                                                && !storage.get(CoreMemoryTypes.ENTITY_ATTACKED_BY_OWNER)
                                                        .equals(this)) {
                                            // 攻击主人攻击的生物
                                        ...
                                        } else if (attackByEntityEvent != null
                                                && validAttacker
                                                && !attackByEntityEvent
                                                        .getDamager()
                                                        .equals(getOwner())) {
                                        ...
                                        } else if (storage.notEmpty(CoreMemoryTypes.NEAREST_SKELETON)
                                                && storage.get(CoreMemoryTypes.NEAREST_SKELETON)
                                                        .isAlive()) {
                                            // 攻击最近的骷髅
                                        ...
                                        if (validAttacker) {
                                            ...
                                            attackTarget = attackByEntityEvent.getDamager();
                                            storage.clear(CoreMemoryTypes.BE_ATTACKED_EVENT);
                                        } else if (storage.notEmpty(CoreMemoryTypes.NEAREST_SUITABLE_ATTACK_TARGET)
                                                && storage.get(CoreMemoryTypes.NEAREST_SUITABLE_ATTACK_TARGET)
                                                        .isAlive()) {
                                            // 攻击最近的合适生物
                                ...
                                entity -> this.getMemoryStorage().isEmpty(CoreMemoryTypes.ATTACK_TARGET),
                                1)),
                Set.of(
                        // 坐下锁定
                        ...
                        new Behavior(
                                ...
                                1),
                        new Behavior(
                                new EntityBreedingExecutor<>(EntityWolf.class, 16, 100, 0.35f),
                        ...
                        new Behavior(
                                ...
                                1),
                        new Behavior(
                                new LookAtFeedingPlayerExecutor(),
                        ...
                        new Behavior(
                                ...
                                50)),
                Set.of(
                        new WolfNearestFeedingPlayerSensor(7, 0),
                        new NearestPlayerSensor(8, 0, 20),
                        new NearestTargetEntitySensor<>(
                                0,
                                20,
                                20,
                                List.of(
                                ...
                                entity -> switch (entity.getNetworkId()) {
                                    case EntitySkeleton.NETWORK_ID,
                                            EntityWitherSkeleton.NETWORK_ID,
                                            EntityStray.NETWORK_ID -> true;
                                    default -> false;
                                }),
    ...
    public boolean onInteract(Player player, Item item, Vector3 clickedPos) {
        ...
        if (item.getId() == ItemID.BONE) {
            ...
            this.getLevel()
                    .addParticle(
                            new ItemBreakParticle(this.add(0, getHeight() * 0.75F, 0), Item.get(item.getId(), 0, 1)));
    ...
    public boolean attackTarget(Entity entity) {
        return switch (entity.getNetworkId()) {
            case EntityRabbit.NETWORK_ID,
                    ...
                    EntitySkeleton.NETWORK_ID,
                    EntityWitherSkeleton.NETWORK_ID,
                    EntityStray.NETWORK_ID,
                    EntityLlama.NETWORK_ID,
                    EntitySheep.NETWORK_ID,
                    EntityTurtle.NETWORK_ID -> true;
            default -> false;
        };
    }

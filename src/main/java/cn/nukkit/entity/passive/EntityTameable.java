...
@DeprecationDetails(
        since = "1.6.0.0-PNX",
        reason = "EntityTameable is moved to interface,which is better to use",
        replaceWith = "interface EntityOwnable")
public abstract class EntityTameable extends EntityAnimal implements EntityOwnable {
    ...
    public Player getOwner() {
        return getServer().getPlayerManager().getPlayer(getOwnerName());
    }

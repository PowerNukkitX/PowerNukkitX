        ...
        return new BehaviorGroup(
                ...
                Set.of(
                        new Behavior(
                                ...
                                1),
                        new Behavior(
                                new EntityBreedingExecutor<>(EntityCow.class, 16, 100, 0.5f),
                                entity -> entity.getMemoryStorage().get(CoreMemoryTypes.IS_IN_LOVE),
                                3,
                                1),
                        new Behavior(
                                new MoveToTargetExecutor(CoreMemoryTypes.NEAREST_FEEDING_PLAYER, 0.4f, true),
    ...
    public Item[] getDrops() {
        if (!this.isBaby()) {
            return new Item[] {
                ...
                Item.get(((this.isOnFire()) ? Item.COOKED_BEEF : Item.RAW_BEEF), 0, Utils.rand(1, 3))
            };
        }

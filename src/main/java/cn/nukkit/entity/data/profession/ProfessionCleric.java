...
public class ProfessionCleric extends Profession {
    ...
    public List<NbtMap> buildTrades(int seed) {
        ...
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.ROTTEN_FLESH, 0, 32), Item.get(Item.EMERALD, 0, 2))
                ...
                .build());
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 1), Item.get(Item.REDSTONE, 0, 2))
                .setMaxUses(16)
                .setRewardExp((byte) 1)
                .setTier(1)
                .setTraderExp(2)
                .setPriceMultiplierA(0.05f)
                .build());
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.GOLD_INGOT, 0, 3), Item.get(Item.EMERALD, 0, 1))
                .setMaxUses(12)
                .setRewardExp((byte) 1)
                .setTier(2)
                .setTraderExp(10)
                .setPriceMultiplierA(0.05f)
                .build());
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 1), Item.get(Item.LAPIS_LAZULI))
                .setMaxUses(12)
                .setRewardExp((byte) 1)
                .setTier(2)
                .setTraderExp(5)
                .setPriceMultiplierA(0.05f)
                .build());
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.RABBIT_FOOT, 0, 2), Item.get(Item.EMERALD, 0, 2))
                .setMaxUses(12)
                .setRewardExp((byte) 1)
                .setTier(3)
                .setTraderExp(20)
                .setPriceMultiplierA(0.05f)
                .build());
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 4), Item.get(BlockID.GLOWSTONE, 0, 1))
                .setMaxUses(12)
                .setRewardExp((byte) 1)
                .setTier(3)
                .setTraderExp(10)
        ...
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 5), Item.get(Item.ENDER_PEARL, 0, 1))
                ...
                .setPriceMultiplierA(0.05f)
                .build());
        recipes.add(TradeRecipeBuildUtils.of(Item.get(BlockID.NETHER_WART, 0, 22), Item.get(Item.EMERALD, 0, 1))
                .setMaxUses(12)
                .setRewardExp((byte) 1)
                .setTier(5)
                .setTraderExp(30)
                .setPriceMultiplierA(0.05f)
                .build());
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 3), Item.get(Item.EXPERIENCE_BOTTLE, 0, 1))
                .setMaxUses(99)
                .setRewardExp((byte) 1)
                .setTier(5)
                .setTraderExp(30)

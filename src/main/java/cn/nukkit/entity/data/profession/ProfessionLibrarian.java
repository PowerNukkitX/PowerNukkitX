    ...
    public ListTag<Tag> buildTrades(int seed) {
        ...
        book4.addEnchantment(e_book4);
            ...
            recipes.add(RecipeBuildUtils.of(Item.get(Item.PAPER,0,24), Item.get(Item.EMERALD))
                        ...
                        .setTraderExp(2)
                        .build())
                .add(RecipeBuildUtils.of(Item.get(Item.EMERALD,0,9), Item.getItemBlock(BlockID.BOOKSHELF))
                        .setMaxUses(16)
                        .setRewardExp((byte) 1)
                        .setTier(1)
                        .setTraderExp(2)
                ...
                .add(RecipeBuildUtils.of(Item.get(Item.BOOK), Item.get(Item.EMERALD))
                        ...
                        .setTraderExp(10)
                        .build())
                .add(RecipeBuildUtils.of(Item.get(Item.EMERALD), Item.getItemBlock(BlockID.LANTERN))
                        .setMaxUses(16)
                        .setRewardExp((byte) 1)
                        .setTier(2)
                        .setTraderExp(5)
                ...
                .add(RecipeBuildUtils.of(Item.get(Item.DYE,0,5), Item.get(Item.EMERALD))
                        ...
                        .setTraderExp(20)
                        .build())
                .add(RecipeBuildUtils.of(Item.get(Item.EMERALD), Item.getItemBlock(BlockID.GLASS, 0,4))
                        .setMaxUses(16)
                        .setRewardExp((byte) 1)
                        .setTier(3)
                        .setTraderExp(10)

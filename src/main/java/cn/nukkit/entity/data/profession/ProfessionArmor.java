...
public class ProfessionArmor extends Profession {
    ...
    public ListTag<Tag> buildTrades(int seed) {
        ...
        Enchantment diamondLeggingsEnchantment =
                Enchantment.getEnchantment(enchantments[random.nextInt(enchantments.length)]);
        ...
        Enchantment diamondChestplateEnchantment =
                Enchantment.getEnchantment(enchantments[random.nextInt(enchantments.length)]);
        ...
        Enchantment diamondHelmetEnchantment =
                Enchantment.getEnchantment(enchantments[random.nextInt(enchantments.length)]);
        ...
        Enchantment diamondBootsEnchantment =
                Enchantment.getEnchantment(enchantments[random.nextInt(enchantments.length)]);

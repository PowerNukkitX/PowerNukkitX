...
public class ProfessionLeather extends Profession {
    ...
    public ListTag<Tag> buildTrades(int seed) {
        ...
        recipes.add(RecipeBuildUtils.of(Item.get(Item.LEATHER, 0, 6), Item.get(Item.EMERALD))
                        ...
                        .setTraderExp(2)
                        .build())
                .add(RecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 7), ((ItemLeatherChestplate) Item.get(Item.LEATHER_CHESTPLATE)).setColor(DyeColor.RED))
                        .setMaxUses(12)
                        .setRewardExp((byte) 1)
                        .setTier(1)
                        .setTraderExp(1)
                        .build())
                .add(RecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 3), ((ItemLeatherLeggings) Item.get(Item.LEATHER_LEGGINGS)).setColor(DyeColor.RED))
                        .setMaxUses(99)
                        .setRewardExp((byte) 1)
                        .setTier(1)
                        .setTraderExp(0)
                ...
                .add(RecipeBuildUtils.of(Item.get(Item.FLINT, 0, 26), Item.get(Item.EMERALD))
                        ...
                        .setTraderExp(10)
                        .build())
                .add(RecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 5), ((ItemLeatherHelmet) Item.get(Item.LEATHER_HELMET)).setColor(DyeColor.RED))
                        .setMaxUses(12)
                        .setRewardExp((byte) 1)
                        .setTier(2)
                        .setTraderExp(5)
                        .build())
                .add(RecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 4), ((ItemLeatherBoots) Item.get(Item.LEATHER_BOOTS)).setColor(DyeColor.RED))
                        .setMaxUses(99)
                        .setRewardExp((byte) 1)
                        .setTier(2)
                        .setTraderExp(0)
                ...
                .add(RecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 7), ((ItemLeatherChestplate) Item.get(Item.LEATHER_CHESTPLATE)).setColor(DyeColor.RED))
                        ...
                        .setTraderExp(10)
                        .build())
                .add(RecipeBuildUtils.of(Item.get(Item.TURTLE_HELMET, 0, 4), Item.get(Item.EMERALD))
                        .setMaxUses(12)
                        .setRewardExp((byte) 1)
                        .setTier(4)
                        .setTraderExp(30)

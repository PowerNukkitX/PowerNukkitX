...
public class ProfessionLeather extends Profession {
    ...
    public List<NbtMap> buildTrades(int seed) {
        ...
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 7), ((ItemLeatherChestplate) Item.get(Item.LEATHER_CHESTPLATE)).setColor(DyeColor.values()[random.nextInt(DyeColor.values().length)]))
                ...
                .setPriceMultiplierA(0.2f)
                .build());
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.TURTLE_HELMET, 0, 4), Item.get(Item.EMERALD))
                .setMaxUses(12)
                .setRewardExp((byte) 1)
                .setTier(4)
                .setTraderExp(30)
                .setPriceMultiplierA(0.05f)
                .build());
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 6), Item.get(Item.LEATHER_HORSE_ARMOR))
                .setMaxUses(12)
                .setRewardExp((byte) 1)
                .setTier(4)
                .setTraderExp(15)

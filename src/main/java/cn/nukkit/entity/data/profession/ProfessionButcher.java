...
public class ProfessionButcher extends Profession {
    ...
    public ListTag<Tag> buildTrades(int seed) {
        ...
        recipes.add(RecipeBuildUtils.of(Item.get(Item.CHICKEN, 0, 14), Item.get(Item.EMERALD))
                        ...
                        .setTraderExp(2)
                        .build())
                .add(RecipeBuildUtils.of(Item.get(Item.PORKCHOP, 0, 7), Item.get(Item.EMERALD))
                        .setMaxUses(99)
                        .setRewardExp((byte) 1)
                        .setTier(1)
                        .setTraderExp(0)
                        .build())
                .add(RecipeBuildUtils.of(Item.get(Item.RABBIT, 0, 4), Item.get(Item.EMERALD))
                        .setMaxUses(99)
                        .setRewardExp((byte) 1)
                        .setTier(1)
                        .setTraderExp(0)
                ...
                .add(RecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 1), Item.get(Item.COOKED_CHICKEN, 0, 8))
                        ...
                        .setTraderExp(0)
                        .build())
                .add(RecipeBuildUtils.of(Item.get(Item.MUTTON, 0, 7), Item.get(Item.EMERALD))
                        .setMaxUses(16)
                        .setRewardExp((byte) 1)
                        .setTier(3)
                        .setTraderExp(30)
                        .build())
                .add(RecipeBuildUtils.of(Item.get(Item.BEEF, 0, 10), Item.get(Item.EMERALD))
                        .setMaxUses(99)
                        .setRewardExp((byte) 1)
                        .setTier(3)
                        .setTraderExp(0)
                ...
                .add(RecipeBuildUtils.of(Item.get(BlockID.DRIED_KELP_BLOCK, 0, 10), Item.get(Item.EMERALD))
                        ...
                        .setTraderExp(30)
                        .build())
                .add(RecipeBuildUtils.of(Item.get(SWEET_BERRIES, 0, 10), Item.get(Item.EMERALD))
                        .setMaxUses(12)
                        .setRewardExp((byte) 1)
                        .setTier(5)
                        .setTraderExp(0)

        ...
        crossbow.addEnchantment(crossbowEnchantment);
            ...
            recipes.add(RecipeBuildUtils.of(Item.get(Item.STICK,0,32), Item.get(Item.EMERALD))
                ...
                .add(RecipeBuildUtils.of(Item.get(Item.EMERALD,0,1), Item.get(Item.ARROW, 0 , 16))
                        ...
                        .setTraderExp(1)
                        .build())
                .add(RecipeBuildUtils.of(Item.get(Item.EMERALD,0,1), Item.getItemBlock(BlockID.GRAVEL, 0 , 10), Item.get(Item.FLINT, 0 , 10))
                        .setMaxUses(16)
                        .setRewardExp((byte) 1)
                        .setTier(1)
                        .setTraderExp(2)
                ...
                .add(RecipeBuildUtils.of(Item.get(Item.EMERALD,0,7 + random.nextInt(15)), bow)
                        ...
                        .setTraderExp(15)
                        .build())
                .add(RecipeBuildUtils.of(Item.getItemBlock(BlockID.TRIPWIRE_HOOK,0,8), Item.get(Item.EMERALD))
                        .setMaxUses(12)
                        .setRewardExp((byte) 1)
                        .setTier(5)
                        .setTraderExp(0)

...
public class ProfessionFletcher extends Profession {
    ...
    public ListTag<Tag> buildTrades(int seed) {
        ...
        int[] crossbowEnchantments = new int[] {
            Enchantment.ID_CROSSBOW_MULTISHOT,
            Enchantment.ID_CROSSBOW_PIERCING,
            Enchantment.ID_CROSSBOW_QUICK_CHARGE,
            Enchantment.ID_DURABILITY
        };
        Enchantment crossbowEnchantment =
                Enchantment.get(crossbowEnchantments[random.nextInt(crossbowEnchantments.length)]);
        ...
        recipes.add(RecipeBuildUtils.of(Item.get(Item.STICK, 0, 32), Item.get(Item.EMERALD))
                ...
                .add(RecipeBuildUtils.of(
                                Item.get(Item.EMERALD, 0, 1), Item.get(Item.GRAVEL, 0, 10), Item.get(Item.FLINT, 0, 10))
                        .setMaxUses(16)
                        .setRewardExp((byte) 1)
                        .setTier(1)
                        .setTraderExp(2)
                ...
                .add(RecipeBuildUtils.of(
                                ...
                                Item.get(Item.ARROW, random.nextInt(43) + 1, 5))
                        .setMaxUses(12)
                        .setRewardExp((byte) 1)
                        .setTier(5)
                        .setTraderExp(0)

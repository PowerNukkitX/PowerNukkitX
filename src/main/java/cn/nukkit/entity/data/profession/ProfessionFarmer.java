    ...
    public ListTag<Tag> buildTrades(int seed) {
        ...
        recipes.add(RecipeBuildUtils.of(Item.get(Item.WHEAT,0,20), Item.get(Item.EMERALD))
                ...
                .add(RecipeBuildUtils.of(Item.get(Item.EMERALD), Item.get(Item.BREAD,0,6))
                        ...
                        .setTraderExp(2)
                        .build())
                .add(RecipeBuildUtils.of(Item.get(BlockID.PUMPKIN,0,6), Item.get(Item.EMERALD))
                        .setMaxUses(16)
                        .setRewardExp((byte) 1)
                        .setTier(2)
                        .setTraderExp(2)
                ...
                .add(RecipeBuildUtils.of(Item.get(Item.EMERALD), Item.get(Item.APPLE,0,4))
                        ...
                        .setTraderExp(2)
                        .build())
                .add(RecipeBuildUtils.of(Item.get(BlockID.MELON_BLOCK, 0, 4), Item.get(Item.EMERALD))
                        .setMaxUses(16)
                        .setRewardExp((byte) 1)
                        .setTier(3)
                        .setTraderExp(2)

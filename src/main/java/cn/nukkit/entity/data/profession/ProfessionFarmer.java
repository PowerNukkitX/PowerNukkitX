...
public class ProfessionFarmer extends Profession {
    ...
    public List<NbtMap> buildTrades(int seed) {
        ...
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD), Item.get(Item.BREAD, 0, 6))
                ...
                .setPriceMultiplierA(0.05f)
                .build());
        recipes.add(TradeRecipeBuildUtils.of(Item.get(BlockID.PUMPKIN, 0, 6), Item.get(Item.EMERALD))
                .setMaxUses(12)
                .setRewardExp((byte) 1)
                .setTier(2)
                .setTraderExp(10)
        ...
        recipes.add(TradeRecipeBuildUtils.of(Item.get(BlockID.MELON_BLOCK, 0, 4), Item.get(Item.EMERALD))
                ...
                .setPriceMultiplierA(0.05f)
                .build());
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 3), Item.get(Item.COOKIE, 0, 18))
                .setMaxUses(12)
                .setRewardExp((byte) 1)
                .setTier(3)
                .setTraderExp(10)
                .setPriceMultiplierA(0.05f)
                .build());
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD), Item.get(Item.SUSPICIOUS_STEW, random.nextInt(6)))
                .setMaxUses(12)
                .setRewardExp((byte) 1)
                .setTier(4)
                .setTraderExp(15)
                .setPriceMultiplierA(0.05f)
                .build());
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD), Item.get(BlockID.CAKE))
                .setMaxUses(12)
                .setRewardExp((byte) 1)
                .setTier(4)
                .setTraderExp(15)
                .setPriceMultiplierA(0.05f)
                .build());
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 3), Item.get(Item.GOLDEN_CARROT, 0, 3))
                .setMaxUses(12)
                .setRewardExp((byte) 1)
                .setTier(5)
                .setTraderExp(30)
                .setPriceMultiplierA(0.05f)
                .build());
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 4), Item.get(Item.GLISTERING_MELON_SLICE, 0, 3))
                .setMaxUses(12)
                .setRewardExp((byte) 1)
                .setTier(3)
                .setTraderExp(30)

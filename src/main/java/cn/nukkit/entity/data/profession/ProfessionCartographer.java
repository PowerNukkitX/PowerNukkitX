    ...
    public ListTag<Tag> buildTrades(int seed) {
        ...
        recipes.add(RecipeBuildUtils.of(Item.get(Item.PAPER, 0, 24), Item.get(Item.EMERALD))
                ...
                .add(RecipeBuildUtils.of(
                                Item.get(Item.EMERALD, 0, 13), Item.get(Item.COMPASS), MinecraftItemID.EMPTY_MAP.get(3))
                        .setMaxUses(12)
                        .setRewardExp((byte) 1)
                        .setTier(2)
                        .setTraderExp(5)
                ...
                .add(RecipeBuildUtils.of(Item.get(Item.COMPASS, 0, 1), Item.get(Item.EMERALD))
                        ...
                        .build())
                .add(RecipeBuildUtils.of(
                                Item.get(Item.EMERALD, 0, 14), Item.get(Item.COMPASS), Item.get(Item.EMPTY_MAP, 0, 3))
                        .setMaxUses(12)
                        .setRewardExp((byte) 1)
                        .setTier(3)
                        .setTraderExp(10)

    ...
    public ListTag<Tag> buildTrades(int seed) {
        ...
        recipes.add(RecipeBuildUtils.of(Item.get(Item.PAPER, 0, 24), Item.get(Item.EMERALD))
                ...
                .add(RecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 7), Item.get(Item.EMPTY_MAP))
                        ...
                        .setTraderExp(1)
                        .build())
                .add(RecipeBuildUtils.of(Item.getItemBlock(BlockID.GLASS_PANE, 0, 11), Item.get(Item.EMERALD))
                        .setMaxUses(16)
                        .setRewardExp((byte) 1)
                        .setTier(2)
                        .setTraderExp(10)
                ...
                .add(RecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 14), Item.get(Item.COMPASS), Item.get(Item.EMPTY_MAP, 0, 3))
                        ...
                        .setTraderExp(10)
                        .build())
                .add(RecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 7), Item.get(Item.FRAME))
                        .setMaxUses(12)
                        .setRewardExp((byte) 1)
                        .setTier(4)
                        .setTraderExp(15)

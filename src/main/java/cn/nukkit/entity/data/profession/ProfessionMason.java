...
public class ProfessionMason extends Profession {
    ...
    public List<NbtMap> buildTrades(int seed) {
        ...
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.CLAY_BALL, 0, 10), Item.get(Item.EMERALD))
                ...
                .build());
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD), Item.get(Item.BRICK, 0, 10))
                .setMaxUses(16)
                .setRewardExp((byte) 1)
                .setTier(1)
                .setTraderExp(1)
                .setPriceMultiplierA(0.05f)
                .build());
        recipes.add(TradeRecipeBuildUtils.of(Item.get(BlockID.STONE, 0, 20), Item.get(Item.EMERALD))
                .setMaxUses(16)
                .setRewardExp((byte) 1)
                .setTier(2)
                .setTraderExp(10)
                .setPriceMultiplierA(0.05f)
                .build());
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 1), Item.get(BlockID.CHISELED_STONE_BRICKS, 0, 4))
                .setMaxUses(16)
                .setRewardExp((byte) 1)
                .setTier(2)
                .setTraderExp(5)

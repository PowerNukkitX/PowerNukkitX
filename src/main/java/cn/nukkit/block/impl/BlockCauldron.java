...
public class BlockCauldron extends BlockSolidMeta implements BlockEntityHolder<BlockEntityCauldron> {
    ...
    public boolean onActivate(@NotNull Item item, Player player) {
        ...
        switch (item.getId()) {
            ...
            case ItemID.DYE:
                ...
                this.getLevel().addSound(this.add(0.5, 0.5, 0.5), Sound.CAULDRON_ADDDYE);
            ...
            case ItemID.LEATHER_HORSE_ARMOR:
                ...
                if (cauldron.isCustomColor()) {
                    ...
                    this.getLevel().addSound(add(0.5, 0.5, 0.5), Sound.CAULDRON_DYEARMOR);
                } else {
    ...
    public void clearWithFizz(BlockEntityCauldron cauldron, @Nullable Player player) {
        ...
        cauldron.clearCustomColor();
        this.getLevel().setBlock(this, new BlockCauldron(0), true);
        this.getLevel().addSound(this.add(0.5, 0, 0.5), Sound.RANDOM_FIZZ);
        for (int i = 0; i < 8; ++i) {

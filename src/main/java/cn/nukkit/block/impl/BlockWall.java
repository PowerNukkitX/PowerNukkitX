...
@PowerNukkitDifference(
        info = "Extends BlockWallBase and implements BlockConnectable only on PowerNukkit",
        since = "1.4.0.0-PN")
public class BlockWall extends BlockWallBase {
    @PowerNukkitOnly
    @Since("1.4.0.0-PN")
    public static final BlockProperty<WallType> WALL_BLOCK_TYPE =
    ...
    @Deprecated
    @DeprecationDetails(
            reason = "No longer matches the meta directly",
            replaceWith = "WallType.COBBLESTONE",
            since = "1.3.0.0-PN")
    ...
    @DeprecationDetails(
            reason = "No longer matches the meta directly",
            replaceWith = "WallType.MOSSY_COBBLESTONE",
            since = "1.3.0.0-PN")

...
public interface BlockDefinitions {
    BlockDefinition.BlockDefinitionBuilder DEFAULT = BlockDefinition.builder()
    ...
    BlockDefinition.BlockDefinitionBuilder TRANSPARENT = DEFAULT.build().toBuilder()
            .isTransparent(true);

    BlockDefinition.BlockDefinitionBuilder FLOWABLE = TRANSPARENT.build().toBuilder()
    ...
    BlockDefinition.BlockDefinitionBuilder WOODEN_BUTTON = BUTTON.build().toBuilder()

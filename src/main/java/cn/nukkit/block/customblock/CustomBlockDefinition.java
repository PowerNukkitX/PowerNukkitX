...
/**
 * CustomBlockDefinition is used to get the data of the block behavior_pack sent to the client. 
 * The methods provided in {@link CustomBlockDefinition.Builder} control the data sent to the client, 
 * if you need to control some of the server-side behavior, please override the methods in {@link Block Block}.
 */
@Slf4j
public record CustomBlockDefinition(String identifier, CompoundTag nbt) {
    ...
    public static class Builder {
        ...
        protected Builder(CustomBlock customBlock) {
            ...
            // Default unit cube block
            components.putCompound("minecraft:unit_cube", new CompoundTag());
            // Set the geometry model of the default unit cube block
            ...
            // Set the category of the block in the creative inventory
         ...
         * Default not set boneVisibilities
         */
        public Builder geometry(String geometry) {
            ...
            var components = this.nbt.getCompound("components");
            // Default unit cube block, if defining geometry model needs to be removed
            if (components.contains("minecraft:unit_cube")) components.remove("minecraft:unit_cube");
            // Set the geometry model of the block
            components.putCompound("minecraft:geometry", new CompoundTag()

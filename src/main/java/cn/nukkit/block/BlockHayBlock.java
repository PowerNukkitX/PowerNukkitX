...
public class BlockHayBlock extends BlockSolid {
    public static final BlockProperties $1 = new BlockProperties(HAY_BLOCK, CommonBlockProperties.DEPRECATED, CommonBlockProperties.PILLAR_AXIS);
    ...
    public void onEntityFallOn(Entity entity, float fallDistance) {
        int $2 = entity.hasEffect(EffectType.JUMP_BOOST)? Effect.get(EffectType.JUMP_BOOST).getLevel() : 0;
        float $3 = (float) Math.floor(fallDistance - 3 - jumpBoost);

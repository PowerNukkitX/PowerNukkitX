...
public class BlockSmoothQuartzStairs extends BlockStairs {
    public static final BlockProperties $1 = new BlockProperties(SMOOTH_QUARTZ_STAIRS, CommonBlockProperties.UPSIDE_DOWN_BIT, CommonBlockProperties.WEIRDO_DIRECTION);

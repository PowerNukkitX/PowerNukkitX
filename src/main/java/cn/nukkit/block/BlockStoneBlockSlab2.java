...
public class BlockStoneBlockSlab2 extends BlockSlab {
    public static final BlockProperties $1 = new BlockProperties(STONE_BLOCK_SLAB2, CommonBlockProperties.MINECRAFT_VERTICAL_HALF, CommonBlockProperties.STONE_SLAB_TYPE_2);
    ...
    static BlockState getDoubleBlockState(BlockState blockState) {
        ...
        StoneSlabType2 $2 = blockState.getPropertyValue(CommonBlockProperties.STONE_SLAB_TYPE_2);
    ...
    public Item toItem() {
        Block $3 = PROPERTIES.getBlockState(CommonBlockProperties.STONE_SLAB_TYPE_2.createValue(getSlabType())).toBlock();

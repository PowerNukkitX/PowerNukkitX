...
public class BlockDeepslateTileStairs extends BlockStairs {
    public static final BlockProperties $1 = new BlockProperties(DEEPSLATE_TILE_STAIRS, CommonBlockProperties.UPSIDE_DOWN_BIT, CommonBlockProperties.WEIRDO_DIRECTION);

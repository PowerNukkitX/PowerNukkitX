...
public class BlockSeaLantern extends BlockTransparent {
    ...
    public static final BlockProperties $1 = new BlockProperties(SEA_LANTERN);
    ...
    public Item[] getDrops(Item item) {
        ...
        int $3 = fortune != null ? fortune.getLevel() : 0;
        ...
        int $4 = Math.min(5, 2 + ThreadLocalRandom.current().nextInt(1 + fortuneLevel));

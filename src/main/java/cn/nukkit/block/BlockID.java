...
public interface BlockID {
    ...
    @DeprecationDetails(
            ...
            since = "FUTURE",
            replaceWith = "LEAVES",
            reason = "Wrong Minecraft block name and English word")
    int LEAVE = LEAVES;
    ...
    @DeprecationDetails(
            by = "PowerNukkit",
            since = "FUTURE",
            replaceWith = "NETHER_BRICK_BLOCK",
            reason = "Confusing name with block and item")
    ...
    @DeprecationDetails(
            by = "PowerNukkitX",
            since = "FUTURE",
            replaceWith = "DOUBLE_RED_SANDSTONE_SLAB",
            reason = "Wrong Minecraft block name")
    ...
    @DeprecationDetails(
            by = "PowerNukkitX",
            since = "FUTURE",
            replaceWith = "RED_SANDSTONE_SLAB",
            reason = "Wrong Minecraft block name")

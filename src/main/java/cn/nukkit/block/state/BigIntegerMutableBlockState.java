...
import static cn.nukkit.block.state.IMutableBlockState.handleUnsupportedStorageType;

import cn.nukkit.api.*;
import cn.nukkit.block.Block;
import cn.nukkit.block.property.BlockProperties;
import cn.nukkit.block.property.BlockProperty;
import cn.nukkit.block.property.exception.InvalidBlockPropertyException;
...
public class BigIntegerMutableBlockState extends MutableBlockState {
    private static final Set<Class<?>> LONG_COMPATIBLE_CLASSES =
            new HashSet<>(Arrays.asList(Long.class, Integer.class, Short.class, Byte.class));

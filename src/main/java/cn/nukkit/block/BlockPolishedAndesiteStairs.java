...
public class BlockPolishedAndesiteStairs extends BlockStairs {
    public static final BlockProperties $1 = new BlockProperties(POLISHED_ANDESITE_STAIRS, CommonBlockProperties.UPSIDE_DOWN_BIT, CommonBlockProperties.WEIRDO_DIRECTION);

...
public class BlockPolishedGraniteStairs extends BlockStairs {
    public static final BlockProperties $1 = new BlockProperties(POLISHED_GRANITE_STAIRS, CommonBlockProperties.UPSIDE_DOWN_BIT, CommonBlockProperties.WEIRDO_DIRECTION);

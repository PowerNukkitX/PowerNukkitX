...
package cn.nukkit.block.property.exception;
...
public class InvalidBlockPropertyPersistenceValueException extends InvalidBlockPropertyException {
    ...
    @Nullable private final String invalidValue;

    @PowerNukkitOnly
    @Since("1.4.0.0-PN")
    public InvalidBlockPropertyPersistenceValueException(
            @NotNull BlockProperty<?> property, String currentValue, String invalidValue) {
    ...
    @Since("1.4.0.0-PN")
    public InvalidBlockPropertyPersistenceValueException(
            @NotNull BlockProperty<?> property, String currentValue, String invalidValue, String message) {
    ...
    @Since("1.4.0.0-PN")
    public InvalidBlockPropertyPersistenceValueException(
            @NotNull BlockProperty<?> property, String currentValue, String invalidValue, Throwable cause) {
    ...
    @PowerNukkitOnly
    @Since("1.4.0.0-PN")
    @Nullable public String getCurrentValue() {
        return this.currentValue;
    }

    @PowerNukkitOnly
    @Since("1.4.0.0-PN")
    @Nullable public String getInvalidValue() {

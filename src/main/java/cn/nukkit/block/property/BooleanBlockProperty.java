...
import cn.nukkit.block.property.exception.InvalidBlockPropertyPersistenceValueException;
...
public final class BooleanBlockProperty extends BlockProperty<Boolean> {
    ...
    @PowerNukkitOnly
    @Since("1.4.0.0-PN")
    @NotNull public Boolean getDefaultValue() {
    ...
    public int getMetaForPersistenceValue(@NotNull String persistenceValue) {
        if ("1".equals(persistenceValue)) {
            ...
            throw new InvalidBlockPropertyPersistenceValueException(
                    this, null, persistenceValue, "Only 1 or 0 was expected");
        }
    }
}

package cn.nukkit.block.property.value;
...
public enum StoneSlab3Type {
    ...
    @PowerNukkitOnly
    @Since("1.4.0.0-PN")
    public static final ArrayBlockProperty<StoneSlab3Type> PROPERTY =
            new ArrayBlockProperty<>("stone_slab_type_3", true, values());
    ...
    StoneSlab3Type(BlockColor color) {
        this.color = color;
        englishName = Arrays.stream(name().split("_"))

...
public record CustomItemDefinition(String identifier, CompoundTag nbt) {
    ...
    @PowerNukkitXOnly
    @Since("1.19.60-r1")
    public static CustomItemDefinition.SimpleBuilder customBuilder(
            CustomItem item, ItemCreativeCategory creativeCategory) {
     ...
     * @param creativeCategory the creative category
     */
    public static CustomItemDefinition.SimpleBuilder simpleBuilder(
     ...
     * @param creativeCategory the creative category
     */
    public static CustomItemDefinition.ToolBuilder toolBuilder(
            ItemCustomTool item, ItemCreativeCategory creativeCategory) {
     ...
     * @param creativeCategory the creative category
     */
    public static CustomItemDefinition.ArmorBuilder armorBuilder(
            ItemCustomArmor item, ItemCreativeCategory creativeCategory) {
     ...
     * @param creativeCategory the creative category
     */
    public static CustomItemDefinition.EdibleBuilder edibleBuilder(
            ItemCustomEdible item, ItemCreativeCategory creativeCategory) {
    ...
    @Nullable public String getDisplayName() {
        ...
        return this.nbt
                ...
                .getCompound("minecraft:display_name")
                .getString("value");
    }
    ...
    public static class SimpleBuilder {
        ...
        protected final CompoundTag nbt = new CompoundTag()
                .putCompound(
                        ...
                        new CompoundTag()
                                .putCompound(
                                        "item_properties",
                                        new CompoundTag().putCompound("minecraft:icon", new CompoundTag())));
        ...
        public SimpleBuilder handEquipped(boolean handEquipped) {
            this.nbt.getCompound("components").getCompound("item_properties").putBoolean("hand_equipped", handEquipped);
            return this;
        }
        ...
        public SimpleBuilder foil(boolean foil) {
            this.nbt.getCompound("components").getCompound("item_properties").putBoolean("foil", foil);
            return this;
        }
        ...
        protected CustomItemDefinition calculateID() {
            ...
            if (!INTERNAL_ALLOCATION_ID_MAP.containsKey(result.identifier())) {
                while (RuntimeItems.getRuntimeMapping().getNamespacedIdByNetworkId(nextRuntimeId.incrementAndGet())
                        != null)
                    ;
        ...
        protected SimpleBuilder addRepairs(@NotNull List<String> repairItemNames, String molang) {
            ...
            if (this.nbt.getCompound("components").contains("minecraft:repairable")) {
                ...
                this.nbt
                        .getCompound("components")
                        .putCompound("minecraft:repairable", new CompoundTag().putList(repair_items));
            }
            return this;
        }
    }
    ...
    public static class ToolBuilder extends SimpleBuilder {
        ...
        public ToolBuilder isWeapon() {
            if (this.item.getAttackDamage() > 0
                    && !this.nbt.getCompound("components").containsCompound("minecraft:weapon")) {
        ...
        public CustomItemDefinition build() {
            ...
            this.nbt
                    .getCompound("components")
                    .putCompound(
                            "minecraft:durability", new CompoundTag().putInt("max_durability", item.getMaxDurability()))
                    .getCompound("item_properties")
            ...
            if (item.isPickaxe()) {
                ...
                if (this.nbt.getCompound("components").contains("item_tags")) {
                    var list = this.nbt
                            .getCompound("components")
                            .getList("item_tags", StringTag.class)
                            .getAll();
                    for (var tag : list) {
            ...
            if (type != null) {
                toolBlocks.get(type).forEach((k, v) -> {
    ...
    public static class ArmorBuilder extends SimpleBuilder {
        ...
        public CustomItemDefinition build() {
            this.nbt
                    .getCompound("components")
                    .putCompound("minecraft:armor", new CompoundTag().putInt("protection", item.getArmorPoints()))
                    .putCompound(
                            "minecraft:durability",
                            new CompoundTag().putInt("max_durability", item.getMaxDurability()));
            if (item.isHelmet()) {
                this.nbt
                        .getCompound("components")
                        .getCompound("item_properties")
                ...
                this.nbt
                        .getCompound("components")
                        .putCompound("minecraft:wearable", new CompoundTag().putString("slot", "slot.armor.head"));
                ...
                this.nbt
                        .getCompound("components")
                        .putCompound("minecraft:wearable", new CompoundTag().putString("slot", "slot.armor.chest"));
                ...
                this.nbt
                        .getCompound("components")
                        .putCompound("minecraft:wearable", new CompoundTag().putString("slot", "slot.armor.legs"));
                ...
                this.nbt
                        .getCompound("components")
                        .putCompound("minecraft:wearable", new CompoundTag().putString("slot", "slot.armor.feet"));
            }
            return calculateID();
        }
    }
    ...
    public static class EdibleBuilder extends SimpleBuilder {
        private EdibleBuilder(ItemCustomEdible item, ItemCreativeCategory creativeCategory) {
            super(item, creativeCategory);
            var food =
                    Food.registerFood(item.getFood().getValue(), item.getFood().getKey());
            if (this.nbt.getCompound("components").contains("minecraft:food")) {
                this.nbt
                        .getCompound("components")
                        .getCompound("minecraft:food")
                        .putBoolean("can_always_eat", item.canAlwaysEat());
            } else {
                this.nbt
                        .getCompound("components")
                        .putCompound(
                                "minecraft:food", new CompoundTag().putBoolean("can_always_eat", item.canAlwaysEat()));
            }

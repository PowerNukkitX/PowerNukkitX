...
/**
 * @deprecated Extend Item directly and implement CustomItem; custom-item hooks are now in Item and definitions use CustomItemDefinition.SimpleBuilder, so this wrapper is no longer needed. <p>

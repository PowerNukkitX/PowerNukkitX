        ...
        public void update(Server server) {
            ...
            //We need the new server settings. Therefore, we're generating the default settings here and injecting them into the server.
                ...
                base.motd(oldProp.get(LegacyServerPropertiesKeys.MOTD, base.motd()))
                                ...
                                .defaultLevelName(oldProp.get(LegacyServerPropertiesKeys.LEVEL_NAME,
                                                base.defaultLevelName()))
                ...
                game.viewDistance(oldProp.get(LegacyServerPropertiesKeys.VIEW_DISTANCE, game.viewDistance()))
                                ...
                                .announceAchievements(
                                                oldProp.get(LegacyServerPropertiesKeys.ANNOUNCE_PLAYER_ACHIEVEMENTS,
                                                                game.announceAchievements()))
                                .spawnProtection(oldProp.get(LegacyServerPropertiesKeys.SPAWN_PROTECTION,
                                                game.spawnProtection()))
                                ...
                                .forceGamemode(oldProp.get(LegacyServerPropertiesKeys.FORCE_GAMEMODE,
                                                game.forceGamemode()))
                                ...
                                .forceResources(oldProp.get(LegacyServerPropertiesKeys.FORCE_RESOURCES,
                                                game.forceResources()))
                                .allowClientPacks(oldProp.get(LegacyServerPropertiesKeys.ALLOW_CLIENT_PACKS,
                                                game.allowClientPacks()))
                                .serverAuthoritativeMovement(
                                                oldProp.get(LegacyServerPropertiesKeys.SERVER_AUTHORITATIVE_MOVEMENT,
                                                                game.serverAuthoritativeMovement()));
                ...
                net.enableQuery(oldProp.get(LegacyServerPropertiesKeys.ENABLE_QUERY, net.enableQuery()))
                                .networkEncryption(oldProp.get(LegacyServerPropertiesKeys.NETWORK_ENCRYPTION,
                                                net.networkEncryption()))
                                .checkLoginTime(oldProp.get(LegacyServerPropertiesKeys.CHECK_LOGIN_TIME,
                                                net.checkLoginTime()));
                settings.save();
        }

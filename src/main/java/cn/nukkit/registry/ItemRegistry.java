...
//        register(BLEACH, ItemBleach.class); //edu
        ...
        register(BREWING_STAND, ItemBrewingStand.class);
...
//        register(COMPOUND, ItemCompound.class);//edu
        ...
        register(COPPER_DOOR, ItemCopperDoor.class);
        ...
        register(EXPOSED_COPPER_DOOR, ItemExposedCopperDoor.class);
        ...
        register(FLOWER_POT, ItemFlowerPot.class);
        register(FOX_SPAWN_EGG, ItemFoxSpawnEgg.class);
        register(FRAME, ItemFrame.class);
        ...
        register(NETHER_SPROUTS, ItemNetherSprouts.class);
        register(NETHER_STAR, ItemNetherStar.class);
        register(NETHER_WART, ItemNetherWart.class);
        ...
        register(OXIDIZED_COPPER_DOOR, ItemOxidizedCopperDoor.class);
        ...
        register(SCUTE, ItemScute.class);
        ...
        register(WAXED_COPPER_DOOR, ItemWaxedCopperDoor.class);
        register(WAXED_EXPOSED_COPPER_DOOR, ItemWaxedExposedCopperDoor.class);
        register(WAXED_OXIDIZED_COPPER_DOOR, ItemWaxedOxidizedCopperDoor.class);
        register(WAXED_WEATHERED_COPPER_DOOR, ItemWaxedWeatheredCopperDoor.class);
        register(WAYFINDER_ARMOR_TRIM_SMITHING_TEMPLATE, ItemWayfinderArmorTrimSmithingTemplate.class);
        register(WEATHERED_COPPER_DOOR, ItemWeatheredCopperDoor.class);
    ...
    @Override
    public OK<?> register(String key, Class<? extends Item> value) {
        try {
            FastConstructor<? extends Item> c = FastConstructor.create(value.getConstructor());
            if (CACHE_CONSTRUCTORS.putIfAbsent(key, c) == null) {
                return OK.TRUE;
            } else {
                return new OK<>(false, new IllegalArgumentException("This item has already been registered with the identifier: " + key));
            }

...
public abstract class DefaultPermissions {
    ...
    public static void registerCorePermissions() {
        ...
        registerPermission(new Permission(ROOT + ".command.targetrealname", "Allows the user to see and target players by their real login names instead of display names", Permission.DEFAULT_OP), commands);

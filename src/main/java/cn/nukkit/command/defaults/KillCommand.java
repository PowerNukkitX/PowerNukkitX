...
public class KillCommand extends VanillaCommand {
    ...
    public KillCommand(String name) {
        ...
        this.commandParameters.put(
                "default", new CommandParameter[] {CommandParameter.newType("player", true, CommandParamType.TARGET)});
    ...
    public int execute(
            ...
            String commandLabel,
            @NotNull Map.Entry<String, ParamList> result,
            CommandLogger log) {
        if (result.getValue().hasResult(0)) {
            ...
            if (entities.isEmpty()) {
                if (creativePlayer.get()) log.addError(TextFormat.WHITE + "%commands.kill.attemptKillPlayerCreative");
            ...
            log.addSuccess("commands.kill.successful", message)

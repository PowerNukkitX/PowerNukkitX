    ...
    public int execute(
        ...
        for (Player target : targets) {
            ...
            if (item == null) {
                ...
                if (count == 0) {
                    log.addError("commands.clear.failure.no.items", target.getName())
                            .output();
                } else {
                    log.addSuccess("commands.clear.success", target.getName(), String.valueOf(count))
                            .output();
                }
            } else if (maxCount == 0) {
                int count = 0;
                ...
                if (count == 0) {
                    ...
                    log.addSuccess("commands.clear.testing", target.getName(), String.valueOf(count))
                            .output();
                }
            } else if (maxCount == -1) {
                int count = 0;
                ...
                if (remaining == maxCount) {
                    ...
                    log.addSuccess("commands.clear.success", target.getName(), String.valueOf(maxCount - remaining))
                            .output();
                }
            }
        }

            ...
            case "block", "block-oldItemHandling" -> {
                ...
                if (slotId < 0 || slotId >= holder.getInventory().getSize()) {
                    log.addError(
                                    ...
                                    "slot.container",
                                    "0",
                                    String.valueOf(holder.getInventory().getSize() - 1))
                            .output();
                    return 0;
                }
                ...
                if (oldItemHandling.equals("keep") && !old.isNull()) {
                    log.addError("commands.replaceitem.keepFailed", "slot.container", String.valueOf(slotId))
                            .output();
                    return 0;
                }
                    ...
                    if (entity instanceof Player player) {
                        ...
                        if (slotId < 0 || slotId >= player.getInventory().getSize()) {
                            log.addError(
                                    ...
                                    slotType,
                                    "0",
                                    String.valueOf(player.getInventory().getSize()));
                            continue;
                        }
                        if (player.getInventory().setItem(slotId, item)) {
                            log.addSuccess(
                        ...
                        if (slotId < 0 || slotId >= entityMob.getInventory().getSize()) {
                            log.addError(
                                    ...
                                    slotType,
                                    "0",
                                    String.valueOf(entityMob.getInventory().getSize()));
                            continue;
                        }

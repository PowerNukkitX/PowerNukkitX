...
public record CommandLogger(Command command, CommandSender sender, String[] args, boolean isPlayer,
     ...
     * 如果发送者是控制台则按Key Value格式化后输出
     */
    public void outputInfo(@Nullable String playerK, @Nullable String[] playerV, String consoleK, String[] consoleV) {
        if (isPlayer) {
            if (sendCommandFeedback) {
                if (playerK != null && playerV != null) {
    ...
    /**
     * playerK=null,playerV=null
     *
     * @see #outputInfo(String, String[], String, String[])
     */
    public void outputInfo(String consoleK, String[] consoleV) {
        this.outputInfo(null, null, consoleK, consoleV);
    }

    /**
     * @see #outputInfo(String, String[])
     */
    public void outputInfo(String consoleK, String consoleV) {
        this.outputInfo(null, null, consoleK, new String[]{consoleV});
    }

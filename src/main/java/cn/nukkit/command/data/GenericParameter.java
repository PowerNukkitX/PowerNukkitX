...
public interface GenericParameter {
    ...
    CommandParameterSupplier<CommandParameter> ITEM_NAME = (optional) -> CommandParameter.newEnum("itemName", optional, CommandEnum.ITEM, new ItemNode());
    CommandParameterSupplier<CommandParameter> CHAINED_COMMAND = (optional) -> CommandParameter.newEnum("chainedCommand", optional, CommandEnum.CHAINED_COMMAND, new ChainedCommandNode(), CommandParamOption.ENUM_AS_CHAINED_COMMAND);

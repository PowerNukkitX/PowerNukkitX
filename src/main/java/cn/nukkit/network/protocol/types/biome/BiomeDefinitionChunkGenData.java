...
public class BiomeDefinitionChunkGenData implements IBiomeDefinitionListObject {
    ...
    public OptionalValue<BiomeReplacementData> replacementBiomes = OptionalValue.empty();
    public OptionalValue<VillageType> villageType = OptionalValue.empty();
    public OptionalValue<BiomeSurfaceBuilderData> surfaceBuilderData = OptionalValue.empty();
    public OptionalValue<BiomeSurfaceBuilderData> subSurfaceBuilderData = OptionalValue.empty();

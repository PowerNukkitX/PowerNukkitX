...
public interface ProtocolInfo {
    ...
    List<Integer> SUPPORTED_PROTOCOLS = Ints.asList(dynamic(594), CURRENT_PROTOCOL);
    ...
    @DeprecationDetails(
            since = "1.5.2.0-PN",
            reason = "Incorrect naming convention",
            by = "PowerNukkit",
            replaceWith = "SYNC_ENTITY_PROPERTY_PACKET")
    ...
    @DeprecationDetails(
            ...
            reason = "Incorrect naming convention",
            by = "PowerNukkit",
            replaceWith = "ADD_VOLUME_ENTITY_PACKET")
    ...
    @DeprecationDetails(
            ...
            reason = "Incorrect naming convention",
            by = "PowerNukkit",
            replaceWith = "REMOVE_VOLUME_ENTITY_PACKET")

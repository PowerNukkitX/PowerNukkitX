...
public interface ProtocolInfo {
     ...
     */
    int CURRENT_PROTOCOL = dynamic(1001);

    String MINECRAFT_VERSION_NETWORK = dynamic("1.26.30");

    SemVersion MINECRAFT_SEMVERSION = new SemVersion(1, 26, 30, 0, 0);
    ...
    int STRUCTURE_DATA_REQUEST = 0x84;
    int STRUCTURE_DATA_RESPONSE = 0x85;
    ...
    int CLIENTBOUND_DDUI_SHOW_SCREEN = 333;
    int CLIENTBOUND_DDUI_CLOSE_SCREEN = 334;
    int CLIENTBOUND_DDUI_RELOAD = 335;
    int CLIENTBOUND_TEXTURE_SHIFT = 336;
    ...
    int SERVERBOUND_DATA_DRIVEN_SCREEN_CLOSED = 343;

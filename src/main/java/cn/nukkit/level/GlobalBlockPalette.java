...
public class GlobalBlockPalette {
    @Deprecated
    @DeprecationDetails(
            reason = "Public mutable array",
            replaceWith = "BlockStateRegistry.getBlockPaletteBytes() or BlockStateRegistry.copyBlockPaletteBytes()",
            since = "1.4.0.0-PN")
    @PowerNukkitOnly
    ...
    @Deprecated
    @DeprecationDetails(
            reason = "Limited to 32 bits meta",
            since = "1.4.0.0-PN",
            replaceWith = "BlockStateRegistry.getRuntimeId(BlockState)")
    ...
    @Deprecated
    @DeprecationDetails(
            reason = "Moved to BlockStateRegistry",
            replaceWith = "BlockStateRegistry.getPersistenceName(int)",
            since = "1.3.0.0-PN")
    @PowerNukkitOnly

...
public class LevelDBProvider implements LevelProvider {
    ...
    @PowerNukkitOnly
    @Since("1.4.0.0-PN")
    public LevelDBProvider(Level level, String path, CompoundTag levelData, Vector3 spawn) {
        this.level = level;
        this.path = path;
    ...
    public abstract Chunk loadChunk(long index, int chunkX, int chunkZ, boolean create);

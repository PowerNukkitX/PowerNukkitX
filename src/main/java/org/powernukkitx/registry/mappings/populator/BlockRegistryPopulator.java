...
public final class BlockRegistryPopulator {
    ...
    public static BlockMappings initMapping() {
        try (InputStream stream = BlockRegistryPopulator.class.getClassLoader().getResourceAsStream("mappings/blocks.json")) {
            ...
            Object2ObjectOpenHashMap<JeBlockState, BlockState> MAP1 = new Object2ObjectOpenHashMap<>();
            Object2ObjectOpenHashMap<BlockState, JeBlockState> MAP2 = new Object2ObjectOpenHashMap<>();
            blocks.forEach((k, v) -> {
                ...
                BlockState pnxBlockState = Registries.BLOCKSTATE.get(i);
            ...
            final BlockState i = BlockFlowingLava.PROPERTIES.getBlockState(CommonBlockProperties.LIQUID_DEPTH.createValue(0));

...
import org.powernukkitx.utils.NbtHelper;
...
public final class BlockRegistryPopulator {
    ...
    public static BlockMappings initMapping() {
        try (InputStream stream = BlockRegistryPopulator.class.getClassLoader().getResourceAsStream("mappings/blocks.json")) {
            ...
            Object2ObjectOpenHashMap<JeBlockState, org.powernukkitx.block.BlockState> MAP1 = new Object2ObjectOpenHashMap<>();
            Object2ObjectOpenHashMap<org.powernukkitx.block.BlockState, JeBlockState> MAP2 = new Object2ObjectOpenHashMap<>();
            blocks.forEach((k, v) -> {
                ...
                org.powernukkitx.block.BlockState pnxBlockState = Registries.BLOCKSTATE.get(i);
            ...
            final org.powernukkitx.block.BlockState i = BlockFlowingLava.PROPERTIES.getBlockState(CommonBlockProperties.LIQUID_DEPTH.createValue(0));

...
public class FuelRegistry implements IRegistry<Item, Integer, Integer> {
    ...
    public void init() {
        ...
        register0(ItemID.WHITE_CUSHION, 50);
        register0(ItemID.ORANGE_CUSHION, 50);
        register0(ItemID.MAGENTA_CUSHION, 50);
        register0(ItemID.LIGHT_BLUE_CUSHION, 50);
        register0(ItemID.YELLOW_CUSHION, 50);
        register0(ItemID.LIME_CUSHION, 50);
        register0(ItemID.PINK_CUSHION, 50);
        register0(ItemID.GRAY_CUSHION, 50);
        register0(ItemID.LIGHT_GRAY_CUSHION, 50);
        register0(ItemID.CYAN_CUSHION, 50);
        register0(ItemID.PURPLE_CUSHION, 50);
        register0(ItemID.BLUE_CUSHION, 50);
        register0(ItemID.BROWN_CUSHION, 50);
        register0(ItemID.GREEN_CUSHION, 50);
        register0(ItemID.RED_CUSHION, 50);
        register0(ItemID.BLACK_CUSHION, 50);

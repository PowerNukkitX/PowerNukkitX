...
import org.powernukkitx.item.customitem.data.DigProperty;
import org.powernukkitx.item.customitem.data.RenderOffsets;
...
public record CustomItemDefinition(String identifier, CompoundTag nbt) implements BlockID {
    ...
    public static class SimpleBuilder {
        ...
        private void writeDamage(CompoundTag itemProps, CompoundTag components) {
            ...
            components.putByte("minecraft:damage", this.damage & 0xFF);
        }

package org.powernukkitx.item.enchantment.protection;
...
public class EnchantmentProtectionAll extends EnchantmentProtection {
    ...
    public float getProtectionFactor(EntityDamageEvent e) {
        ...
        if (level <= 0 || cause == DamageCause.VOID || cause == DamageCause.CUSTOM || cause == DamageCause.MAGIC || cause == DamageCause.HUNGER || cause == DamageCause.SONIC_BOOM) {
            return 0;
        }

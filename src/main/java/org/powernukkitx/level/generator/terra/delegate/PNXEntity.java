...
public class PNXEntity implements Entity {
    private final org.powernukkitx.entity.Entity nukkitEntity;
    private ServerWorld world;

    public PNXEntity(org.powernukkitx.entity.Entity nukkitEntity, ServerWorld world) {
    ...
    public org.powernukkitx.entity.Entity entity() {
        return nukkitEntity;
    }
}

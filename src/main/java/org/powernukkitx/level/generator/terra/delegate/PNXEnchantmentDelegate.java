...
public record PNXEnchantmentDelegate(org.powernukkitx.item.enchantment.Enchantment innerEnchantment) implements Enchantment {
    @Override
    ...
    @Override
    public org.powernukkitx.item.enchantment.Enchantment getHandle() {

...
public class ObjectExitPortal extends ObjectGenerator {
    ...
    protected static final BlockState BEDROCK = BlockBedrock.PROPERTIES.getBlockState(INFINIBURN_BIT.createValue(true));
    ...
    public boolean generate(BlockManager level, RandomSourceProvider rand, Vector3 pos) {
        ...
        Vector3 torchCenter = new Vector3(originX, originY + 2, originZ);
        for (BlockFace face : BlockFace.getHorizontals()) {
            level.setBlockStateAt(torchCenter.getSide(face),

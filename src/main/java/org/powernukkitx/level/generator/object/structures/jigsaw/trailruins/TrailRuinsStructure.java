...
public class TrailRuinsStructure extends JigsawStructure {
    ...
    private void replaceRandomGravel(BlockManager blockManager, List<Block> gravelBlocks, RandomSourceProvider random, int count, BlockState replacement, TrailRuinsLoot loot) {

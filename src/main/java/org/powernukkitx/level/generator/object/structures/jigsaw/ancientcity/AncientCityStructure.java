...
public class AncientCityStructure extends JigsawStructure {
    ...
    private static void populatePool(Inventory inventory, RandomSourceProvider random, List<SpecialItemEntry> entries, int totalWeight, int minRolls, int maxRolls) {
        try {

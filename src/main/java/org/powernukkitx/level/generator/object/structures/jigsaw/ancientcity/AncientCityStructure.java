package org.powernukkitx.level.generator.object.structures.jigsaw.ancientcity;
...
import static org.powernukkitx.block.BlockID.SCULK;
import static org.powernukkitx.block.BlockID.SCULK_CATALYST;
import static org.powernukkitx.block.BlockID.SCULK_SENSOR;
import static org.powernukkitx.block.BlockID.SOUL_TORCH;
import static org.powernukkitx.block.property.CommonBlockProperties.CAN_SUMMON;
...
public class AncientCityStructure extends JigsawStructure {
    ...
    protected static class AncientCityChestPopulator extends RandomizableContainer {
        ...
        @Override
        public void create(org.powernukkitx.inventory.Inventory inventory, RandomSourceProvider random) {
    ...
    private static void populatePool(org.powernukkitx.inventory.Inventory inventory, RandomSourceProvider random, List<SpecialItemEntry> entries, int totalWeight, int minRolls, int maxRolls) {
        try {

...
import org.powernukkitx.lang.PluginI18n;
...
public record CommandLogger(Command command,
    ...
    /**
     * 添加一条消息，参数可以是纯文本，也可以是客户端，服务端，以及{@link PluginI18n PluginI18n}中的多语言文本，默认输出颜色红色
     * <p>
     * Add a message, the parameters can be plain text, or client-side, server-side, and multilingual text in {@link PluginI18n PluginI18n}, default output color red
     *
     * @param key the key
     * @return the command logger
     */

 ...
 * @see org.powernukkitx.command.tree.node.ItemNode
 * @see org.powernukkitx.command.tree.node.ChainedCommandNode
 */
public interface GenericParameter {
     ...
     * Produces a parameter named "itemName" using {@link CommandEnum#ENUM_ITEM} and {@link org.powernukkitx.command.tree.node.ItemNode} for advanced parsing.
     */

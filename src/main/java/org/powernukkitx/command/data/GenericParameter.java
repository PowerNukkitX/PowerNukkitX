...
import org.powernukkitx.command.tree.node.ChainedCommandNode;
import org.powernukkitx.command.tree.node.ItemNode;
...
public interface GenericParameter {
     ...
     * Produces a parameter named "itemName" using {@link CommandEnum#ENUM_ITEM} and {@link ItemNode} for advanced parsing.
     */
     ...
     * Produces a parameter named "chainedCommand" using {@link CommandEnum#CHAINED_COMMAND_ENUM}, {@link ChainedCommandNode}, and {@link CommandParamOption#ENUM_AS_CHAINED_COMMAND}.
     */

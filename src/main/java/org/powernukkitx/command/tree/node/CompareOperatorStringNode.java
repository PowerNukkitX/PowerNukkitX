 ...
 * <p>
 * This node is used for all command parameters of type {@link org.powernukkitx.command.data.CommandParamType#COMPARE_OPERATOR COMPARE_OPERATOR}
 ...
 * @see org.powernukkitx.command.data.CommandParamType#COMPARE_OPERATOR
 * @see IParamNode
 * @since PowerNukkitX 1.19.50
 * Responsible for parsing comparison operations within ExecuteCommand, resolving them to {@link String} values
 * <p>
 * All command parameters are of type {@link org.powernukkitx.command.data.CommandParamType#COMPARE_OPERATOR COMPARE_OPERATOR}. If no {@link IParamNode} is manually specified, this parser is used by default.
 */

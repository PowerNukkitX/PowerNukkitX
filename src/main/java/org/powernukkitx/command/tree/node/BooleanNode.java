 ...
 * <p>
 * This node is used for all command enums of type {@link org.powernukkitx.command.data.CommandEnum#ENUM_BOOLEAN ENUM_BOOLEAN}
 ...
 * @see Boolean
 * @see org.powernukkitx.command.data.CommandEnum#ENUM_BOOLEAN
 * @see IParamNode
 * @since PowerNukkitX 1.19.50
 * <p>
 * The parsing parameter corresponds to a {@link Boolean} value.
 * All commands enumerated as {@link org.powernukkitx.command.data.CommandEnum#ENUM_BOOLEAN ENUM_BOOLEAN} will default to this parser if no {@link IParamNode} is manually specified.
 */

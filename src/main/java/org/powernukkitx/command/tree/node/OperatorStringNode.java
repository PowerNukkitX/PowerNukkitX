 ...
 * <p>
 * This node is used for all command parameters of type {@link org.powernukkitx.command.data.CommandParamType#OPERATOR OPERATOR}
 ...
 * @see org.powernukkitx.command.data.CommandParamType#OPERATOR
 * @see IParamNode
 * @since PowerNukkitX 1.19.50
 * Verify if it is an operation parameter and parse the corresponding parameter as a {@link String} value
 * <p>
 * All command parameters are of type {@link org.powernukkitx.command.data.CommandParamType#OPERATOR OPERATOR}. If no {@link IParamNode} is manually specified, this parser will be used by default.
 */

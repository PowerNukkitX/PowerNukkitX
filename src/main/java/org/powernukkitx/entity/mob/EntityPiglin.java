    ...
    public IBehaviorGroup requireBehaviorGroup() {
        return BehaviorGroup.builder(this)
                ...
                .sensors(new NearestPlayerSensor(40, 0, 20),
                        ...
                        new NearestEntitySensor(EntityZombiePigman.class, CoreMemoryTypes.NEAREST_SHARED_ENTITY, 8, 0, ISensor.DEFAULT_TARGETING_PERIOD),
                        new NearestEntitySensor(EntityZoglin.class, CoreMemoryTypes.NEAREST_SHARED_ENTITY, 8, 0, ISensor.DEFAULT_TARGETING_PERIOD),
                        new NearestEntitySensor(EntityWither.class, CoreMemoryTypes.NEAREST_SHARED_ENTITY, 8, 0, ISensor.DEFAULT_TARGETING_PERIOD),
                        new NearestEntitySensor(EntityWitherSkeleton.class, CoreMemoryTypes.NEAREST_SHARED_ENTITY, 8, 0, ISensor.DEFAULT_TARGETING_PERIOD),

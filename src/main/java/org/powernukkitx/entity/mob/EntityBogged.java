...
public class EntityBogged extends EntityMob implements EntityWalkable, EntitySmite {
    ...
    protected IBehaviorGroup requireBehaviorGroup() {
        return EntityAI.of(this)
                ...
                .behavior(new BowShootExecutor(this::getItemInHand, CoreMemoryTypes.ATTACK_TARGET, 0.3f, 15, true, 35, 20))
                        .when(new EntityCheckEvaluator(CoreMemoryTypes.ATTACK_TARGET))
                .behavior(new BowShootExecutor(this::getItemInHand, CoreMemoryTypes.NEAREST_PLAYER, 0.3f, 15, true, 35, 20))

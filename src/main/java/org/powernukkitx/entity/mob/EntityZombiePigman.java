...
import org.powernukkitx.entity.ai.sensor.MemorizedBlockSensor;
...
public class EntityZombiePigman extends EntityMob implements EntityWalkable, EntitySmite { //Mojang seems to kept the old name?
    ...
    public IBehaviorGroup requireBehaviorGroup() {
        return EntityAI.of(this)
                ...
                .behavior(new PlaySoundExecutor(Sound.MOB_ZOMBIEPIG_ZPIG, isBaby() ? 1.3f : 0.8f, isBaby() ? 1.7f : 1.2f, 1, 1))

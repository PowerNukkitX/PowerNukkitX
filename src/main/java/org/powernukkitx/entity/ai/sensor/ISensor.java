...
/**
 * 此接口抽象了一个传感器 <br/>
 * 传感器用于搜集环境信息并向记忆存储器{@link IMemoryStorage}写入一个记忆{@link MemoryType}
 * <p>
 * This interface abstracts a sensor<br>
 * The sensor is used to collect environmental information and write a memory {@link MemoryType} to the memory storage {@link IMemoryStorage}
 */

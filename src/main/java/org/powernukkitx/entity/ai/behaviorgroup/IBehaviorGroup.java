...
public interface IBehaviorGroup {
    ...
    /**
     * 调用行为组内部的所有行为{@link IBehavior}的评估器{@link IBehaviorEvaluator}
     * <p>
     * Call the evaluator {@link IBehaviorEvaluator} of all behavior {@link IBehavior} inside the behavior group
     *
     * @param entity 目标实体对象
     */
    ...
    /**
     * 调用行为组内部的所有核心行为{@link IBehavior}的评估器{@link IBehaviorEvaluator}
     * <p>
     * Call the evaluator {@link IBehaviorEvaluator} of all core behavior {@link IBehavior} inside the behavior group
     *
     * @param entity 目标实体对象
     */
    ...
    /**
     * 调用行为组内部所有被激活的行为{@link IBehavior}的执行器{@link IBehaviorExecutor}
     * <p>
     * Call the executor {@link IBehaviorExecutor} of all activated behavior {@link IBehavior} inside the behavior group
     *
     * @param entity 目标实体对象
     */
    ...
    /**
     * 调用行为组内部所有被激活的核心行为{@link IBehavior}的执行器{@link IBehaviorExecutor}
     * <p>
     * Call the executor {@link IBehaviorExecutor} of all activated core behavior {@link IBehavior} inside the behavior group
     *
     * @param entity 目标实体对象
     */

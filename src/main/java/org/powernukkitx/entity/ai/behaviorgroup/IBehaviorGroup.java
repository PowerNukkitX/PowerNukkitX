...
public interface IBehaviorGroup {
    ...
    /**
     * 调用行为组内部的所有行为{@link IBehavior}的评估器{@link org.powernukkitx.entity.ai.evaluator.IBehaviorEvaluator}
     * <p>
    ...
    /**
     * 调用行为组内部的所有核心行为{@link IBehavior}的评估器{@link org.powernukkitx.entity.ai.evaluator.IBehaviorEvaluator}
     * <p>
    ...
    /**
     * 调用行为组内部所有被激活的行为{@link IBehavior}的执行器{@link org.powernukkitx.entity.ai.executor.IBehaviorExecutor}
     * <p>
    ...
    /**
     * 调用行为组内部所有被激活的核心行为{@link IBehavior}的执行器{@link org.powernukkitx.entity.ai.executor.IBehaviorExecutor}
     * <p>

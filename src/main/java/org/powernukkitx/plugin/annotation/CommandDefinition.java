...
/**
 * Marks a {@link Command} subclass for automatic registration.
 * <p>
 ...
 * instantiates it via the no-argument {@link Command#Command()}
 * constructor, applies the metadata below (name through
 * {@link Command#setName(String)}, the rest through the
 ...
 * <ul>
 *     <li>The annotated type must extend {@link Command}.</li>

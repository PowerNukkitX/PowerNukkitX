 ...
 * <ul>
 *     <li>{@link org.powernukkitx.plugin.annotation.PluginMeta} on the main class emits
 *     {@code plugin.yml} — no handwritten descriptor.</li>
 *     <li>{@link org.powernukkitx.plugin.annotation.EventListener} registers listeners
 *     automatically.</li>
 *     <li>{@link org.powernukkitx.plugin.annotation.ScheduleTask} schedules tasks
 *     automatically.</li>
 *     <li>{@link org.powernukkitx.plugin.annotation.CommandDefinition} registers commands

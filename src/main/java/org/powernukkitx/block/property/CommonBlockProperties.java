...
public interface CommonBlockProperties {
    ...
    BooleanPropertyType CONNECTION_EAST = BooleanPropertyType.of("minecraft:connection_east", false);

    BooleanPropertyType CONNECTION_NORTH = BooleanPropertyType.of("minecraft:connection_north", false);

    BooleanPropertyType CONNECTION_SOUTH = BooleanPropertyType.of("minecraft:connection_south", false);

    BooleanPropertyType CONNECTION_WEST = BooleanPropertyType.of("minecraft:connection_west", false);

    EnumPropertyType<Corner> CORNER = EnumPropertyType.of("minecraft:corner", Corner.class, Corner.NONE);
    ...
    IntPropertyType GROWTH_1 = IntPropertyType.of("growth", 0, 1, 0);

    ...
    void TestNBT2SNBT() {
        var oldNBT = new LinkedCompoundTag()
                ...
                .putList(new ListTag<>("list1")
                        .add(new ListTag<>("1").add(new IntTag("", 2)).add(new IntTag("", 3)))
                        .add(new ListTag<>("2").add(new DoubleTag("", 3.33)).add(new DoubleTag("", 4.44)))
                        .add(new ListTag<>("2")
                                .add(new ByteArrayTag("", new byte[] {9, 8, 7, 6, 5}))
                                .add(new ByteArrayTag("", new byte[] {11, 22, 33, 44, 55}))))
                .putList(new ListTag<>("list2")
                        .add(new CompoundTag().putString("string1", "asdafsdf").putString("string2", "afasdfcc"))
                        .add(new CompoundTag().putString("string1", "asdafsdf").putString("string2", "afasdfcc")))
                .putCompound(
                        "nestCompoundTag",
                        new CompoundTag().putString("string3", "123123123").putString("string4", "zxdzsfdsdf"));

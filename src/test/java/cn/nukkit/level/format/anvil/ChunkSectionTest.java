...
class ChunkSectionTest {
    ...
    void longPersistence() {
        ...
        ChunkSection loaded = new ChunkSection(nbt);
        assertEquals(
                BigInteger.valueOf(0x81_34_00_00L),
                loaded.getBlockState(0, 0, 0).getHugeDamage());
    }
    ...
    void hugeIdPersistence() {
        ...
        assertEquals(
                (byte) 0b0001_1001,
                compoundTag.getList("DataHyper", ByteArrayTag.class).get(0).data[anvilIndex]);
        ...
        assertEquals(
                (byte) 0b0011_0100,
                compoundTag.getList("DataHyper", ByteArrayTag.class).get(1).data[anvilIndex]);
        assertEquals(
                (byte) 0b0111_0001,
                compoundTag.getList("DataHyper", ByteArrayTag.class).get(2).data[anvilIndex]);

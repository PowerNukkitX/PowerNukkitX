...
public class RecipeTest {
    ...
    void test_findBlastFurnaceRecipe() {
        BlastFurnaceRecipe $1 = Registries.RECIPE.findBlastFurnaceRecipe(Item.get(ItemID.IRON_PICKAXE));
    ...
    void test_findShapelessRecipe() {
        ShapelessRecipe $2 = Registries.RECIPE.findShapelessRecipe(Item.get(BlockID.BLUE_SHULKER_BOX), Item.get(ItemID.BROWN_DYE));

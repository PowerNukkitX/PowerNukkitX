...
public class JsonConfigTest {
    ...
    public void testJson() throws IOException {
        ...
        try (var fis = new FileInputStream(file)) {
            jsonConfig.load(fis);
            Assertions.assertEquals("{a2=a3, b2={a3=a4}}", jsonConfig.getSection("a0.b1").toString());
            Assertions.assertEquals("{a1=[a2, b2, c2], b1={a2=a3, b2={a3=a4}}}", jsonConfig.getSection("a0").toString());

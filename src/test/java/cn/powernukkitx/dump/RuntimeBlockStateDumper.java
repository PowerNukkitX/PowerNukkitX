...
public class RuntimeBlockStateDumper {
    public static void main(String[] args) throws IOException {
        ...
        for (CompoundTag block : tags) {
            ...
            for (var e : block.getCompound("states").getEntrySet()) {
        ...
        for (CompoundTag block : tags) {
            ...
            if (statesCompound.isEmpty()) {
                ...
                for (var e : statesCompound.getEntrySet()) {
                    SortedSet<String> registeredValues = registeredProperties.computeIfAbsent(e.getKey(), k -> new TreeSet<>(humanStringComparator));
                    registeredValues.add(e.getValue().parseValue().toString());
                }
            }
        }

...
public class TerminalTypeAheadManager {
    ...
    public static class TypeAheadEvent {
        ...
        private static final Map<Sequence, EventType> sequenceToEventType = new HashMap<>();

        static {
            sequenceToEventType.put(new Sequence(Ascii.ESC, '[', '3', '~'), EventType.Delete);
            sequenceToEventType.put(new Sequence(Ascii.DEL), EventType.Backspace);
            sequenceToEventType.put(new Sequence(Ascii.ESC, Ascii.DEL), EventType.AltBackspace);
            sequenceToEventType.put(new Sequence(Ascii.ESC, 'O', 'D'), EventType.LeftArrow);
            sequenceToEventType.put(new Sequence(Ascii.ESC, '[', 'D'), EventType.LeftArrow);
            sequenceToEventType.put(new Sequence(Ascii.ESC, 'O', 'C'), EventType.RightArrow);
            sequenceToEventType.put(new Sequence(Ascii.ESC, '[', 'C'), EventType.RightArrow);
            sequenceToEventType.put(new Sequence(Ascii.ESC, 'b'), EventType.AltLeftArrow);
            sequenceToEventType.put(new Sequence(Ascii.ESC, '[', '1', ';', '3', 'D'), EventType.AltLeftArrow);
            // It's ctrl+left arrow, but behaves just the same
            sequenceToEventType.put(new Sequence(Ascii.ESC, '[', '1', ';', '5', 'D'), EventType.AltLeftArrow);
            sequenceToEventType.put(new Sequence(Ascii.ESC, 'f'), EventType.AltRightArrow);
            sequenceToEventType.put(new Sequence(Ascii.ESC, '[', '1', ';', '3', 'C'), EventType.AltRightArrow);
            // It's ctrl+right arrow, but behaves just the same
            sequenceToEventType.put(new Sequence(Ascii.ESC, '[', '1', ';', '5', 'C'), EventType.AltRightArrow);
            sequenceToEventType.put(new Sequence(Ascii.ESC, '[', 'H'), EventType.Home);
            sequenceToEventType.put(new Sequence(Ascii.ESC, 'O', 'H'), EventType.Home);
            sequenceToEventType.put(new Sequence(1), EventType.Home); // ctrl + a
            sequenceToEventType.put(new Sequence(Ascii.ESC, '[', 'F'), EventType.End);
            sequenceToEventType.put(new Sequence(Ascii.ESC, 'O', 'F'), EventType.End);
            sequenceToEventType.put(new Sequence(5), EventType.End); // ctrl + e
        }
        ...
        switch (keyEvent.myEventType) {
            case Character:
                ...
                if (newLineWCursorX.myLineText.length() < newLineWCursorX.myCursorX) {
                    newLineWCursorX.myLineText.append(StringUtils.repeat(" ", (newLineWCursorX.myCursorX - newLineWCursorX.myLineText.length())));
                }
